...
void MainWindow::on_chooseColorBtn_triggered()
{
    ...
    if (! ui->setColorDistanceSlider->isEnabled()) {
...
{
    colorDistanceThreshold = value;

    cDetect.setColorDistanceThreshold(colorDistanceThreshold);
}

void MainWindow::on_setColorDistanceSlider_sliderReleased()
{
